...
namespace EgwarancjeDbLibrary.Migrations
{
    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "WarrantiesSpecs",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WarrantyId = table.Column<int>(type: "int", nullable: false),
                    OrderSpecId = table.Column<int>(type: "int", nullable: false),
                    Comments = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WarrantiesSpecs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WarrantiesSpecs_OrdersSpec_OrderSpecId",
                        column: x => x.OrderSpecId,
                        principalTable: "OrdersSpec",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attachments_WarrantiesSpecs_WarrantySpecId",
                        column: x => x.WarrantySpecId,
                        principalTable: "WarrantiesSpecs",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateIndex(
                name: "IX_Attachments_WarrantySpecId",
                table: "Attachments",
                column: "WarrantySpecId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarrantiesSpecs_WarrantyId",
                table: "WarrantiesSpecs",
                column: "WarrantyId");
        }
