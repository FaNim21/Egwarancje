...
namespace EgwarancjeAPI.Migrations
{
    ...
    [Migration("20240726104234_CartUpdate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EgwarancjeDbLibrary.Models.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EgwarancjeDbLibrary.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EgwarancjeDbLibrary.Models.Cart", b =>
                {
                    b.HasOne("EgwarancjeDbLibrary.Models.User", "User")
                        .WithOne("Cart")
                        .HasForeignKey("EgwarancjeDbLibrary.Models.Cart", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
